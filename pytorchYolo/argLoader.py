...
class ArgLoader:
    def __init__(self):
        ...
        self.parser.add_argument("--save_images", help="Save labled images", default=False, type=bool)
        self.parser.add_argument("--save_predictions_path", help="Path to save network predictions", default=dirname(dirname(abspath(__file__))) + "/data/detections/", type=str)
        self.parser.add_argument("--save_predictions_name", help="Sub-folder to save detections", default=" ", type=str)
